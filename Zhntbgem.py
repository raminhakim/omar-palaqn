...
def action():
    ...
    if bch == '':
        ...
        try:
            c = raw_input('\x1b[1;92m RQamek Halbzhera : ')
            k = '+964'
            idlist = '.txt'
    ...
    time.sleep(0.1)
    psb('\x1b[1;92m[\xe2\x9c\x93]\x1b[1;92m Hack Krdn Daste pe Krd ...')
    time.sleep(0.1)
    psb('\x1b[1;92m[\xe2\x9c\x93]\x1b[1;92m Tawaku 15 Daqa Rawa ...')
    time.sleep(0.1)
